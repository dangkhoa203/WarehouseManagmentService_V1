...
{
    public interface IDataService<T, N, S> where T : class where N : NewGenericDTO where S : ShowGenericDTO
    {
        ...
        Task<S> FindById(string id, ServiceRegistered serviceRegistered);
    }
}
