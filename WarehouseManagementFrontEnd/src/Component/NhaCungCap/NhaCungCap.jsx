...
export default function NhaCungCap(props) {
    ...
    return (<>
        <div className="p-5 pt-0">
            <h1 className="pt-4 text-center">Danh sách nhà cung cấp</h1>
            <Link className="btn btn-outline-primary border-2 fw-bold mb-2" to="tao"><i className="bi bi-plus-circle"> Tạo thêm nhà cung cấp</i></Link>
