...
export default function NewNhomKhachHang(props) {
    ...
    return (
        <>
            <div className="container d-flex justify-content-center p-5 w-100 ">
                <form className="w-50 border border-3 rounded-4 p-3 bg-white d-flex justify-content-center flex-column" onSubmit={handleSubmit(onSubmit)}>
                    <p className="h1 text-center mb-3">Tạo nhóm khách hàng</p>
                    <button type={"button"} className="btn btn-outline-dark border-3 fw-bold  text-start mb-2" style={{width: "120px"}}
