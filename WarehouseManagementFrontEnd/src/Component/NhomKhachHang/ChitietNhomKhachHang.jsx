...
export default function ChitietNhomKhachHang(props) {
    //
    const {id} = useParams()
    ...
    const getGroup = async () => {
        setLoading(true);
        const response = await fetch(`https://localhost:7075/api/v1/Customer-Groups/${id}`, {
    ...
    return (
        <>
            <div className="container pt-1 m-auto">
                <h1 className="text-center fw-bold">Thông tin nhóm khách hàng</h1>
                            ...
                            <h4 className="text-danger">{editError}</h4>
                            {
                                editMode ?
                                    <div className="d-flex flex-row gap-4 pb-5">
                                        <button className="btn btn-outline-secondary w-25 fw-bold border-3" onClick={() => setEditMode(false)}>Hủy
                                        </button>
                                    ...
                                    <div className="d-flex flex-row gap-4 pb-5">
                                        ...
                                        <button className="btn btn-outline-secondary w-25 fw-bold border-3" onClick={() => setEditMode(true)}>Sửa
                                        </button>
                                    </div>
                            }
                            <div className={'modalpanel ' + (deleteModal ? "modal-active" : "")}>
                                <div
                                    ...
                                    <div className='align-bottom d-flex gap-3 justify-content-center p-2'>
                                        ...
                                        <button className='btn btn-success w-50 fw-bold border-3' onClick={() => Delete()}>Ok</button>
                                    </div>
                                </div>
                            </div>
                        </> :
