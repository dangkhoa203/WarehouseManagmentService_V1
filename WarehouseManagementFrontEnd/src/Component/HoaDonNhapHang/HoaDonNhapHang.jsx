...
export default function HoaDonNhapHang(props) {
    ...
    const COLUMNS = [
        ...
        {label: 'Ngày thanh toán', renderCell: (item) => new Date(item.dateOrder).toLocaleString('En-GB', {
            year: "numeric",
            month: "2-digit",
            day: "2-digit",
            hour12: false
    ...
    return (<>
        <div className="p-5 pt-0">
            <h1 className="pt-4 text-center">Danh sách hoá đơn nhập hàng </h1>
            <Link className="btn btn-outline-primary border-2 fw-bold mb-2" to="tao"><i className="bi bi-plus-circle"> Tạo thêm hoá đơn nhập hàng</i></Link>
