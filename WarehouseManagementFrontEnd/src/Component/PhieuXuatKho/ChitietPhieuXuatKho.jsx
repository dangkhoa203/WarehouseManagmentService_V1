...
export default function ChitietPhieuXuatKho(props) {
    //
    const {id} = useParams()
    ...
    const getForm = async () => {
        setLoading(true);
        const response = await fetch(`https://localhost:7075/api/v1/export-Forms/${id}`, {
    ...
    return (
        <div className="container pt-1 m-auto">
            <h1 className="text-center fw-bold">Thông tin phiếu xuất kho</h1>
                            ...
                            <div className="col-4">
                                ...
                                {editMode ?
                                    <div className="form-floating ">
                                        ...
                                        <label htmlFor="floatingInput">Ngày xuất kho</label>
                                    </div>
