...
export default function HoaDonMuaHang(props) {
    ...
    return (<>
        <div className="p-5 pt-0">
            <h1 className="pt-4 text-center">Danh sách hoá đơn mua hàng</h1>
            <Link className="btn btn-outline-primary border-2 fw-bold mb-2" to="tao"><i className="bi bi-plus-circle"> Tạo thêm hoá đơn mua hàng</i></Link>
