...
export default function PhieuHoanTien(props){
    const [nodes,setNodes]=useState([
    ]);
    const [err,setError]=useState("");
    const getList = async () =>{
        const response = await fetch('https://localhost:7075/api/v1/Return-Buy-Forms', {
    ...
    return (<>
        <div className="p-5 pt-0">
            <h1 className="pt-4 text-center">Danh sách phiếu hoàn tiền</h1>
            <Link className="btn btn-outline-primary border-2 fw-bold mb-2" to="tao"><i className="bi bi-plus-circle"> Tạo thêm phiếu hoàn tiền</i></Link>
