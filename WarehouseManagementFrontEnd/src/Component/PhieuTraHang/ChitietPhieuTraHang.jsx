...
export default function ChitietPhieuTraHang(props) {
    //
    const {id} = useParams()
    ...
    const getForm = async () => {
        setLoading(true);
        const response = await fetch(`https://localhost:7075/api/v1/Return-Replenish-Forms/${id}`, {
    ...
    return (
        <div className="container pt-1 m-auto">
            <h1 className="text-center fw-bold">Thông tin phiếu trả hàng</h1>
